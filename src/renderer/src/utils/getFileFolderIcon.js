...
const fileIcons = {
  ...
  "python-config": {
    fileNames: ["pyproject.toml", "requirements.txt", ".python-version"],
  },
  python: {
    languageIds: ["python"],
    fileExtensions: ["py"],
...
const folderIcons = {
  ...
  dist: {
    folderNames: ["dist", "out", "build", "release", "bin", ".output"],
  },
  docker: {
...
export function getIconCode(filename) {
  // Check if the filename directly matches
  ...
  return "_file"; // Return null if no match is found
}


export function getFolderCode(filename) {
    // Check if the filename directly matches
    if (folderNames[filename]) {
      return folderNames[filename];
    }
  

  
    return "_folder"; // Return null if no match is found
  }

// // Example Usage
// console.log(getIconCode("test.aep")); // Output: "adobe-ae"
// console.log(getIconCode("angular.json")); // Output: "angular"
// console.log(getIconCode("example.asm")); // Output: "assembly"
// console.log(getIconCode("unknown.file")); // Output: null

// console.log(getFolderCode(".asd"));
